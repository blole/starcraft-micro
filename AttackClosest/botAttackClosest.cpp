...
void BotAttackClosest::onFrame()
{
	...
	const static std::string BotAttackClosestDescription = "Attack closest opponent";
	Broodwar->drawTextScreen(50, 0,  "FPS: %d", Broodwar->getFPS() );
	Broodwar->drawTextScreen(50, 20, "Average FPS: %f", Broodwar->getAverageFPS() );
	Broodwar->drawTextScreen(100,0, "BotAttackClosest behavior is: %s", BotAttackClosestDescription);
