...
namespace Bot { namespace Search { namespace Behaviors
{
	...
	*/
	...
	public:
		...
		virtual BehaviorTreeInternalNode& BehaviorTreeInternalNode::addChild(unique_ptr<BehaviorTreeNode> newChild)
		{
	...
	struct Always : BehaviorTreeNode_CRTP<Always<StatusType>>
	{
	protected:
		const StatusType status;
	public:
		Always(StatusType status = StatusType())
			: status(status)
		{}
